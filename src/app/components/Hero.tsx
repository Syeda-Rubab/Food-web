    ...
    <div className="relative min-h-screen">
      ...
      src="/hero2.png"
       ...
       <div className="container h-[calc(100vh-120px)] grid items-center">
        <div className="relative space-y-4 bg-[ffffff98] w-fit p-4 top-10 left-10">
          ...
          <p className="text-gray-700 text-[14px] sm:text-[16px]">
            Delicious food color, aroma and teste. <br/>
            What are you waiting for?
          </p>
          <button className="bg-accent text-white px-6 py-2 rounded-3xl text-[14px] sm:text-[16px] hover:bg-green-700"> 
            View More
          </button>
        </div>
       </div>
